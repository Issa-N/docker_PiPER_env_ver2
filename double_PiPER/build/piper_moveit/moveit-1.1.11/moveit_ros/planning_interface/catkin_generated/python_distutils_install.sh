...
echo_and_run cd "/home/rllab/docker_PiPER_env_ver2/double_PiPER/src/piper_moveit/moveit-1.1.11/moveit_ros/planning_interface"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/rllab/docker_PiPER_env_ver2/double_PiPER/build/piper_moveit/moveit-1.1.11/moveit_ros/planning_interface \
    build --build-base "/home/rllab/docker_PiPER_env_ver2/double_PiPER/build/piper_moveit/moveit-1.1.11/moveit_ros/planning_interface" \
    install \
    --root="${DESTDIR-/}" \
