...
get_filename_component(_filename "/home/rllab/docker_PiPER_env_ver2/double_PiPER/src/piper_moveit/moveit_ctrl/srv/JointMoveitCtrl.srv" NAME_WE)
add_custom_target(_moveit_ctrl_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "moveit_ctrl" "/home/rllab/docker_PiPER_env_ver2/double_PiPER/src/piper_moveit/moveit_ctrl/srv/JointMoveitCtrl.srv" ""
)
...
_generate_srv_cpp(moveit_ctrl
  "/home/rllab/docker_PiPER_env_ver2/double_PiPER/src/piper_moveit/moveit_ctrl/srv/JointMoveitCtrl.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/moveit_ctrl)
  install(CODE "execute_process(COMMAND \"/home/rllab/.pyenv/shims/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/moveit_ctrl\")")
  # install generated code
  install(
