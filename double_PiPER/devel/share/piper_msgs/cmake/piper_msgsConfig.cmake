...
if("TRUE" STREQUAL "TRUE")
  set(piper_msgs_SOURCE_PREFIX /home/rllab/docker_PiPER_env_ver2/double_PiPER/src/piper_msgs)
  set(piper_msgs_DEVEL_PREFIX /home/rllab/docker_PiPER_env_ver2/double_PiPER/devel)
  ...
  set(piper_msgs_INSTALL_PREFIX /home/rllab/docker_PiPER_env_ver2/double_PiPER/install)
...
if(NOT "/home/rllab/docker_PiPER_env_ver2/double_PiPER/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'piper_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rllab/docker_PiPER_env_ver2/double_PiPER/src/piper_msgs/${idir}'.  ${_report}")
    endif()
